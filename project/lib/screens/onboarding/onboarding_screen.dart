...
import 'package:project/Widget/Animate_Button_WelcomePage.dart';
import 'package:project/constants/Colors.dart';
import 'package:project/screens/Signin_Signup.dart/CustomSignInDialog.dart';
import 'package:rive/rive.dart';
      ...
      body: Stack(
        children: [
          const ParticlesFly(
            ...
            lineColor: Color.fromARGB(255, 161, 213, 255),
            particleColor: Color.fromARGB(
                255, 207, 233, 255), // Change this color as needed
          ),
          SafeArea(
              child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 32, vertical: 40),
